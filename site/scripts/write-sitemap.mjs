...
const urls = [
  ...
  loc('/blog', 'weekly', '0.7'),
  loc('/blog/why-dethana', 'monthly', '0.5'),
  loc('/blog/reading-pali-with-a-study-translation', 'monthly', '0.5'),
  loc('/blog/start-with-the-dhammapada', 'monthly', '0.5'),
  loc('/blog/the-sixth-council-text', 'monthly', '0.5'),
